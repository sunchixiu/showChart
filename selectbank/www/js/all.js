...
$(function() {
	$("body").append('<div class="loading-div" style="display: none;"><div class="loading-bg"></div><div class="loading-img"></div></div>');
	initLoading();
});
function initLoading() {
	$(".loading-img").css({
		"top":(((window_height - $(".loading-img").height()) / 2) + "px"),
		"left":(((1080 - $(".loading-img").width()) / 2) + "px"),		
	});
}
...
function base(url) {
	return "http://wxmall.zzss.com/" + url;
}
...
function filterName(name) {
	if (Tools.validatePhoneNum(name)) {
...
Tools = {
	...
	isNumber: function(number){
		return number != null && number != undefined && this.isNotBlankStr(number + "") && !isNaN(number);
	},
	 ...
	 */
	isNull: function(obj){
		return obj === undefined || obj === null || obj == "" || obj == "null" || obj == "(null)" || obj == "<null>";
	},
	...
	isBlankStr : function(str){
		return this.isNull(str) || !this.isString(str) || this.trim(str) == "" || this.trim(str) == "(null)";
	},
	 ...
	 */
	validateValidateCode : function(validateCode){
		if(!this.isNull(validateCode)){
			return Tools.validateCodeReg.test(validateCode);
		}
	...
	validateSex : function(sex){
		if(!this.isNull(sex) && 
			(dataEnum.userInfo.sex.male === sex || dataEnum.userInfo.sex.female === sex || dataEnum.userInfo.sex.f === sex || dataEnum.userInfo.sex.m === sex)){
			return true;
		}
