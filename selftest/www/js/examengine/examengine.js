var examengine = {
    ...
    bindevent: function () {
        ...
        if (examengine.issingledisplay) {
            ...
            function listentouch(){
                    ...
                    function fnEnd(){
                        if(Math.abs(tY) < Math.abs(tX)){
                            ...
                            if(tX < -100){
                                ...
                                if(oDivnext){
                                    startMove(oDivend, tX, '-'+subwidth, true);
                                    startMove(oDivnext[0], (subwidth+tX), 0);

                                    examengine.singleindex = examengine.singleindex + 1;
                                }else{
                                    startMove(oDivend, tX, 0, true);
                                };
                                ...
                                if(oDivnext){
                                    startMove(oDivend, tX, 0, true);
                                    startMove(oDivnext[0], (subwidth+tX), subwidth);
                                }else{
                                    startMove(oDivend, tX, 0, true);
                                };
                                oDiv.removeEventListener('touchstart',fnStart,false);
                                ...
                                if(oDivprev){
                                    startMove(oDivendpre, tX, subwidth, true);
                                    startMove(oDivprev[0], (-subwidth+tX), 0);

                                    examengine.singleindex = examengine.singleindex - 1;
                                }else{
                                    startMove(oDivendpre, tX, 0, true);
                                };
                                oDiv.removeEventListener('touchstart',fnStart,false);
                            }else if(tX > 20){
                                var oDivendpre = oDiv;
                                ...
                                if(oDivprev){
                                    startMove(oDivendpre, tX, 0, true);
                                    startMove(oDivprev[0], (-subwidth+tX), -subwidth);
                                }else{
                                    startMove(oDivendpre, tX, 0, true);
                                };
                                oDiv.removeEventListener('touchstart',fnStart,false);
                            ...
                            var currentlength = $('.subquestion').eq(examengine.singleindex).offset().left;
                            if(currentlength < 0){
                                var oDivend = oDiv;
                                if(!nextstate){
                                    oDivend = $('.subquestion').eq(examengine.singleindex)[0];
                                ...
                                if(oDivnext){
                                    startMove(oDivend, currentlength, 0, true);
                                    startMove(oDivnext[0], (subwidth+currentlength), subwidth);
                                }else{
                                    startMove(oDivend, currentlength, 0, true);
                                };
                            }else{
                                ...
                                if(oDivprev){
                                    startMove(oDivendpre, currentlength, 0, true);
                                    startMove(oDivprev[0], (-subwidth+currentlength), -subwidth);
                                }else{
                                    startMove(oDivendpre, currentlength, 0, true);
                                };
                            };
                ...
                function startMove(obj, starttX, iTarget, touchstate){
    ...
    handdlesubquestion: function (model) {
        ...
        else if (examengine.status == "piyue")
        {
            ...
            html = html + "<div class='analysebox myanswer'><span>我的答案：</span><div>" + _myanswerjson.result + "</div></div>";
...
function swipquestion(){
    ...
    function listentouch(){
        //显示试卷分数
        $('.examheader').show().children().hide();
        $('.exam_score').show().css({'z-index': 100});

        var subparents = $('.subquestion').eq(examengine.singleindex).parents('.examsections');
        var subparent = $('.subquestion').eq(examengine.singleindex).parent();
        $('.examparts').css('height', (subparent.find('.title').height() + $('.subquestion').eq(examengine.singleindex).height()) + 'px');
        subparent.css('height', (subparent.find('.title').height() + $('.subquestion').eq(examengine.singleindex).height()) + 'px');
        var nextstate = false;
        var prevstate = false;
        $('.examsections').hide();
        $('.equestion').hide();
        ...
        function fnStart(ev){
            ...
            function fnEnd(){
                var subtimer = null;
                var subease = 200;
                $(".subquestion").css({'-webkit-transition':subease + 'ms all ease'});
                $(".equestion").css({'-webkit-transition':subease + 'ms all ease'});
                ...
                if(tX < -100){
                    ...
                    if(oDivnext){
                        oDivend.style.marginLeft = '-' + subwidth + 'px';
                        oDivnext[0].style.marginLeft = '0px';
                        examengine.singleindex = examengine.singleindex + 1;
                    }else{
                        oDivend.style.marginLeft = '0px';
                    };
                }else if(tX < 0){
                    var oDivend = oDiv;
                    if(!nextstate){
                    ...
                    if(oDivnext){
                        oDivend.style.marginLeft = '0px';
                        oDivnext[0].style.marginLeft = subwidth + 'px';
                    }else{
                ...
                if(tX > 100){
                    ...
                    if(oDivprev){
                        oDivendpre.style.marginLeft = subwidth + 'px';
                        oDivprev[0].style.marginLeft = '0px';
                        examengine.singleindex = examengine.singleindex - 1;
                    }else{
                        oDivendpre.style.marginLeft = '0px';
                    };
                }else if(tX > 0){
                    var oDivendpre = oDiv;
                    if(!prevstate){
                    ...
                    if(oDivprev){
                        oDivendpre.style.marginLeft = '0px';
                        oDivprev[0].style.marginLeft = '-' + subwidth + 'px';
                    }else{
                        oDivendpre.style.marginLeft = '0px';
                    };
                };
                ...
                subtimer = setTimeout(function(){
                    $(".subquestion").css({'-webkit-transition':''});
                    $(".equestion").css({'-webkit-transition':''});
                    listentouch();
                },subease);
                oDiv.removeEventListener('touchstart',fnStart,false);
                oDiv.removeEventListener('touchmove',fnMove,false);
...
function swipquestion(){
    ...
    function listentouch(){
        var subparents = $('.subquestion').eq(examengine.singleindex).parents('.examsections');
        var subparent = $('.subquestion').eq(examengine.singleindex).parent();
        var subnum = subparent.find('.subquestion').length;
        $('.examsections').hide();
        $('.equestion').hide();
        $('.subquestion').hide();
        subparent.css({'display': 'block'});
        subparents.css({'display': 'block'});
        $('.subquestion').eq(examengine.singleindex).show();
        oDiv = document.querySelectorAll('.subquestion')[examengine.singleindex];
        if($('.subquestion').length > 0){
            var _bigid = $(".subquestion").eq(examengine.singleindex).parent().attr("data-id");
            var _newbigid = $(".subquestion").eq(examengine.singleindex+1).parent().attr("data-id");
            if(examengine.singleindex == $('.subquestion').length-1){
                ...
                if(_bigid == _newbigid){
                    ...
                    oDiv = $('.subquestion').eq(examengine.singleindex).parent()[0];
                    oDivnext = $('.subquestion').eq(examengine.singleindex + 1).parent();
                    $('.subquestion').eq(examengine.singleindex + 1).parents('.examsections').show();
                    oDivnext.find('.subquestion').eq(0).show();
                };
        ...
        function fnStart(ev){
            ...
            function fnEnd(){
                ...
                if(tX < -200){
                    if(oDivnext){
                        oDiv.style.marginLeft = '-' + subwidth + 'px';
                        oDivnext[0].style.marginLeft = '0px';
                        examengine.singleindex = examengine.singleindex + 1;
                    }else{
                        oDiv.style.marginLeft = '0px';
