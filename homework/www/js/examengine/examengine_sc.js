var examengine = {
    ...
    allexamshow: function () {
        ...
        if (examengine.issingledisplay == false) {
            ...
            html = html + " <p onclick='getdatajson();'>◇ 作答时间为 <span id='examsheet_time' data-time='" + examengine.examtime + "'>" + examengine.examtime + "分钟</span>; 试卷分数为 <span id='examsheet_score'></span>分<p>";
        ...
        $.each(examengine.examjson.examparts, function (p, model) {
            ...
            $.each(model.examsections, function (se, sectionmodel) {
                ...
                if (sectionmodel.title != "") {
                    ...
                    if (examengine.status == "edit") {
                        if(2 > sectionmodel.title.indexOf('、') > -1){
        ...
        $(".examsections").each(function (esindex) {
            ...
            $(this).find(".equestion").each(function () {
                ...
                $(this).find(".subquestion").each(function () {
                    ...
                    alert($(this).find(".questionanswer").html());
                ...
                _myexamscore = _mytotalscore + _mytotalscore;
            });
            if (_sectionjson != "")
