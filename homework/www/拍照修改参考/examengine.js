                ...
                $(this).find(".subquestion").each(function () {
                    ...
                    if ($(this).find("textarea").length > 0) {
                        ...
                        if ($(this).find('.addphoto').eq(0).find('li').length > 0) {
                            for (var j = 0; j < $(this).find('.addphoto').eq(0).find('li.lishow').length - 1; j++) {
...
function swipquestion(){
    $('.equestion').css({'display':'block','height':$('body').height()+'px'});
    ...
    function listentouch(){
        ...
        $('.equestion').hide();
        $('.subquestion').hide();
        subparent.css({'width': subnum*36 + 'rem', 'display': 'block'});
        $('.subquestion').eq(examengine.singleindex).show();
        ...
        if($('.subquestion').length > 0){
            ...
            if(examengine.singleindex == subnum){
                oDivnext = null;
            }else{
                if(_bigid == _newbigid){
