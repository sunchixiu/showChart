...
function showWindow(id){
    ...
    oDivWindow.style.zIndex = '9998';

    var oDivCover = document.createElement('div');
    oDivCover.id = 'cover';
    oDivCover.style.backgroundColor = 'rgba(0,0,0,0)';
    oDivCover.style.width = '100%';
    oDivCover.style.height = '100%';
    oDivCover.style.zIndex = '9999';
    oDivCover.style.position = 'fixed';
    oDivCover.style.top = 0;
    oDivCover.style.left = 0;
    document.body.appendChild(oDivCover);
    var oDivWindowCover = document.getElementById('cover');
    ...
    setTimeout(function(){
        document.body.removeChild(oDivWindowCover);
    },400);
};
